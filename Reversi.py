...
#---------------------<Class: __init__>---------------------#
    ...
    def Board(self):
        ...
        self.__White = pygame.image.load("Player_White.png")
        self.__Black = pygame.image.load("Player_Black.png")
        self.__Options = pygame.image.load("Player_Possible_move.png")
        self.__Erase = pygame.image.load("Erase.png")
        self.__TextEraser = pygame.image.load("TextEraser.png")
        self.__font = pygame.font.Font('SF-Compact-Rounded-Regular.otf', 24)
